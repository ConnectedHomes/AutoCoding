...
- (void)setWithCoder:(NSCoder *)aDecoder
{
    ...
    for (NSString *key in properties)
    {
        ...
        if (object)
        {
            // Check we are unarchiving the correct class - unless we are unarchiving an NSNull
            if (secureSupported && ![object isKindOfClass:class] && ![object isKindOfClass:[NSNull class]])
            {
